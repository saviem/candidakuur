...
<div class="mx-auto max-w-3xl px-4 py-12 sm:px-6">
    ...
    <p class="mt-4 text-muted">
        Onbeperkte assistent, dagboek, en volledige Wat nu?-kaarten op candidakuur.nl.
    </p>
    ...
    @if ($isPlus)
        <div class="mt-8 rounded-[24px] border border-line bg-accent-soft p-6">
            ...
            <a href="{{ route('account.edit') }}#plus" class="mt-4 inline-flex text-sm font-medium text-accent hover:underline">Beheer Plus in Mijn account</a>
        </div>
    @else
