...
<div class="mx-auto flex max-w-6xl flex-col items-center px-4 py-16 sm:px-6 sm:py-24">
    ...
    <p class="mt-3 max-w-md text-center text-muted">Daarna sturen we een code van 6 cijfers naar je e-mail.</p>

    <form method="POST" action="{{ route('register.send') }}" class="mt-10 w-full max-w-md rounded-[28px] border border-line bg-card p-6 sm:p-8">
        @csrf
